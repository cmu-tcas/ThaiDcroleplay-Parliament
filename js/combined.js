fetch("https://thaidcroleplay-parliament.pages.dev/data/combined.json")
  ...
  .then(data => {
    ...
    setMemberCount('set1');  // เริ่มต้นแสดงจำนวนสมาชิกฝ่ายรัฐบาลและฝ่ายค้าน
    ...
    document.getElementById("data_set").addEventListener("change", function () {
      ...
      setMemberCount(selectedSet);  // เรียกใช้ฟังก์ชันเพื่ออัปเดตจำนวนสมาชิก
    });
  })
  .catch(error => {
...
// ฟังก์ชันกำหนดจำนวนสมาชิกฝ่ายรัฐบาลและฝ่ายค้านจากชุดที่เลือก
